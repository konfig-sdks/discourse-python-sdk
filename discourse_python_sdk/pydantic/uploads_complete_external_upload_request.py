...
class UploadsCompleteExternalUploadRequest(BaseModel):
    ...
    for_private_message: typing.Optional[str] = Field(None, alias='for_private_message')

    # Optionally set this to true if the upload is for a site setting.
    for_site_setting: typing.Optional[str] = Field(None, alias='for_site_setting')

    # Optionally set this to true if the upload was pasted into the upload area. This will convert PNG files to JPEG.
    pasted: typing.Optional[str] = Field(None, alias='pasted')
