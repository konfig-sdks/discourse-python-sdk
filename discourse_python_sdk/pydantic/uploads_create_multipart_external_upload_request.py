...
class UploadsCreateMultipartExternalUploadRequest(BaseModel):
    upload_type: Literal["avatar", "profile_background", "card_background", "custom_emoji", "composer"] = Field(alias='upload_type')
