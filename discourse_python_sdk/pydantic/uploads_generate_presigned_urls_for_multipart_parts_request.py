...
class UploadsGeneratePresignedUrlsForMultipartPartsRequest(BaseModel):
    # The part numbers to generate the presigned URLs for, must be between 1 and 10000.
    part_numbers: typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(alias='part_numbers')
