...
class BackupsListResponseItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "size", "last_modified", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "size", "last_modified", ], str]):
