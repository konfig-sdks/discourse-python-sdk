...
class UsersDeleteUserByIdJsonResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["deleted"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["deleted"], ]):
