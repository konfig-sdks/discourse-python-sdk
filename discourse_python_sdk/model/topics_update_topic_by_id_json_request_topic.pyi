...
class TopicsUpdateTopicByIdJsonRequestTopic(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "category_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "category_id", ], str]):
