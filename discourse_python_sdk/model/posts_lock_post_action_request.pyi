...
class PostsLockPostActionRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["locked", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["locked", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        locked: typing.Union[MetaOapg.properties.locked, str, ],
