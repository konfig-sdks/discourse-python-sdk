...
class UsersSilenceByIdRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["silenced_till"], typing_extensions.Literal["reason"], typing_extensions.Literal["message"], typing_extensions.Literal["post_action"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["silenced_till"]) -> typing.Union[MetaOapg.properties.silenced_till, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["silenced_till"], typing_extensions.Literal["reason"], typing_extensions.Literal["message"], typing_extensions.Literal["post_action"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        silenced_till: typing.Union[MetaOapg.properties.silenced_till, str, schemas.Unset] = schemas.unset,
