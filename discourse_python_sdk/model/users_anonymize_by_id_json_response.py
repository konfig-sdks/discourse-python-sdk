...
class UsersAnonymizeByIdJsonResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["success"], typing_extensions.Literal["username"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["success"], typing_extensions.Literal["username"], ]):
