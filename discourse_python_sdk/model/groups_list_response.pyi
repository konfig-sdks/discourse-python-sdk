...
class GroupsListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                is_group_owner = schemas.BoolSchema
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["is_group_owner"]) -> MetaOapg.properties.is_group_owner: ...
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "automatic", "name", "display_name", "user_count", "mentionable_level", "messageable_level", "visibility_level", "primary_group", "grant_trust_level", "incoming_email", "has_messages", "flair_url", "flair_bg_color", "flair_color", "bio_raw", "bio_cooked", "bio_excerpt", "public_admission", "public_exit", "allow_membership_requests", "full_name", "default_notification_level", "membership_request_template", "is_group_user", "is_group_owner", "members_visibility_level", "can_see_members", "can_admin_group", "can_edit_group", "publish_read_state", ], str]):
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["is_group_user"]) -> typing.Union[MetaOapg.properties.is_group_user, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["is_group_owner"]) -> typing.Union[MetaOapg.properties.is_group_owner, schemas.Unset]: ...
                        ...
                        def __new__(
                            ...
                            *args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            is_group_user: typing.Union[MetaOapg.properties.is_group_user, bool, schemas.Unset] = schemas.unset,
                            is_group_owner: typing.Union[MetaOapg.properties.is_group_owner, bool, schemas.Unset] = schemas.unset,
            ...
            class extras(
                ...
                type_filters: MetaOapg.properties.type_filters
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["type_filters"]) -> MetaOapg.properties.type_filters: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["type_filters", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["type_filters"]) -> MetaOapg.properties.type_filters: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type_filters", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    type_filters: typing.Union[MetaOapg.properties.type_filters, list, tuple, ],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'extras':
                    return super().__new__(
            ...
            total_rows_groups = schemas.IntSchema
            load_more_groups = schemas.StrSchema
            __annotations__ = {
                "groups": groups,
                "extras": extras,
                "total_rows_groups": total_rows_groups,
                "load_more_groups": load_more_groups,
            }
        additional_properties = schemas.NotAnyTypeSchema
    
    load_more_groups: MetaOapg.properties.load_more_groups
    extras: MetaOapg.properties.extras
    groups: MetaOapg.properties.groups
    total_rows_groups: MetaOapg.properties.total_rows_groups
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["load_more_groups"]) -> MetaOapg.properties.load_more_groups: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["total_rows_groups"]) -> MetaOapg.properties.total_rows_groups: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["load_more_groups"], typing_extensions.Literal["extras"], typing_extensions.Literal["groups"], typing_extensions.Literal["total_rows_groups"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["load_more_groups"]) -> MetaOapg.properties.load_more_groups: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["total_rows_groups"]) -> MetaOapg.properties.total_rows_groups: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["load_more_groups"], typing_extensions.Literal["extras"], typing_extensions.Literal["groups"], typing_extensions.Literal["total_rows_groups"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        load_more_groups: typing.Union[MetaOapg.properties.load_more_groups, str, ],
        ...
        total_rows_groups: typing.Union[MetaOapg.properties.total_rows_groups, decimal.Decimal, int, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs,
    ) -> 'GroupsListResponse':
        return super().__new__(
