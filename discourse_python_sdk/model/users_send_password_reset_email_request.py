...
class UsersSendPasswordResetEmailRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["login"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["login"], ]):
