...
class TagsGetTagGroupsResponseTagGroupsItemPermissions(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["staff", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["staff", ], str]):
    ...
    ) -> 'TagsGetTagGroupsResponseTagGroupsItemPermissions':
