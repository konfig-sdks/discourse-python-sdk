...
class BadgesUpdateBadgeByIdJsonRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["badge_type_id"], typing_extensions.Literal["name"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["badge_type_id"], typing_extensions.Literal["name"], ]):
