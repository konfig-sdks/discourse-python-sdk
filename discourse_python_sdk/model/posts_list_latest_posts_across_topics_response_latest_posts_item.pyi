...
class PostsListLatestPostsAcrossTopicsResponseLatestPostsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            topic_title = schemas.StrSchema
            topic_html_title = schemas.StrSchema
            ...
            @staticmethod
            def actions_summary() -> typing.Type['PostsListLatestPostsAcrossTopicsResponseLatestPostsItemActionsSummary']:
                return PostsListLatestPostsAcrossTopicsResponseLatestPostsItemActionsSummary
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["topic_title"]) -> MetaOapg.properties.topic_title: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["topic_html_title"]) -> MetaOapg.properties.topic_html_title: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions_summary"]) -> 'PostsListLatestPostsAcrossTopicsResponseLatestPostsItemActionsSummary': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "id", "name", "username", "avatar_template", "created_at", "cooked", "post_number", "post_type", "updated_at", "reply_count", "reply_to_post_number", "quote_count", "incoming_link_count", "reads", "readers_count", "score", "yours", "topic_id", "topic_slug", "topic_title", "topic_html_title", "category_id", "display_username", "primary_group_name", "flair_name", "flair_url", "flair_bg_color", "flair_color", "flair_group_id", "can_edit", "can_delete", "can_recover", "can_see_hidden_post", "can_wiki", "user_title", "raw", "actions_summary", "moderator", "admin", "staff", "user_id", "hidden", "trust_level", "deleted_at", "user_deleted", "edit_reason", "can_view_edit_history", "wiki", "reviewable_id", "reviewable_score_count", "reviewable_score_pending_count", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["topic_title"]) -> typing.Union[MetaOapg.properties.topic_title, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["topic_html_title"]) -> typing.Union[MetaOapg.properties.topic_html_title, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions_summary"]) -> typing.Union['PostsListLatestPostsAcrossTopicsResponseLatestPostsItemActionsSummary', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        topic_title: typing.Union[MetaOapg.properties.topic_title, str, schemas.Unset] = schemas.unset,
        topic_html_title: typing.Union[MetaOapg.properties.topic_html_title, str, schemas.Unset] = schemas.unset,
        category_id: typing.Union[MetaOapg.properties.category_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        display_username: typing.Union[MetaOapg.properties.display_username, str, schemas.Unset] = schemas.unset,
        ...
        actions_summary: typing.Union['PostsListLatestPostsAcrossTopicsResponseLatestPostsItemActionsSummary', schemas.Unset] = schemas.unset,
        ...
        reviewable_id: typing.Union[MetaOapg.properties.reviewable_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
    ...
    ) -> 'PostsListLatestPostsAcrossTopicsResponseLatestPostsItem':
