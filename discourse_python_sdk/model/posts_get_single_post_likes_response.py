...
class PostsGetSinglePostLikesResponse(
    schemas.DictSchema
):
    """
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                acted = schemas.BoolSchema
                                can_undo = schemas.BoolSchema
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["acted"]) -> MetaOapg.properties.acted: ...
                        
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["can_undo"]) -> MetaOapg.properties.can_undo: ...
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "count", "acted", "can_undo", "can_act", ], str]):
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["acted"]) -> typing.Union[MetaOapg.properties.acted, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["can_undo"]) -> typing.Union[MetaOapg.properties.can_undo, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["can_act"]) -> typing.Union[MetaOapg.properties.can_act, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "count", "acted", "can_undo", "can_act", ], str]):
                        ...
                        def __new__(
                            ...
                            *args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            acted: typing.Union[MetaOapg.properties.acted, bool, schemas.Unset] = schemas.unset,
                            can_undo: typing.Union[MetaOapg.properties.can_undo, bool, schemas.Unset] = schemas.unset,
                            can_act: typing.Union[MetaOapg.properties.can_act, bool, schemas.Unset] = schemas.unset,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hidden"], typing_extensions.Literal["flair_color"], typing_extensions.Literal["can_wiki"], typing_extensions.Literal["moderator"], typing_extensions.Literal["wiki"], typing_extensions.Literal["admin"], typing_extensions.Literal["created_at"], typing_extensions.Literal["trust_level"], typing_extensions.Literal["score"], typing_extensions.Literal["can_view_edit_history"], typing_extensions.Literal["reviewable_score_count"], typing_extensions.Literal["actions_summary"], typing_extensions.Literal["updated_at"], typing_extensions.Literal["incoming_link_count"], typing_extensions.Literal["can_delete"], typing_extensions.Literal["post_type"], typing_extensions.Literal["id"], typing_extensions.Literal["topic_id"], typing_extensions.Literal["quote_count"], typing_extensions.Literal["readers_count"], typing_extensions.Literal["avatar_template"], typing_extensions.Literal["edit_reason"], typing_extensions.Literal["bookmarked"], typing_extensions.Literal["cooked"], typing_extensions.Literal["reads"], typing_extensions.Literal["can_edit"], typing_extensions.Literal["raw"], typing_extensions.Literal["staff"], typing_extensions.Literal["flair_url"], typing_extensions.Literal["reply_count"], typing_extensions.Literal["reply_to_post_number"], typing_extensions.Literal["deleted_at"], typing_extensions.Literal["version"], typing_extensions.Literal["flair_bg_color"], typing_extensions.Literal["reviewable_score_pending_count"], typing_extensions.Literal["reviewable_id"], typing_extensions.Literal["user_id"], typing_extensions.Literal["can_recover"], typing_extensions.Literal["primary_group_name"], typing_extensions.Literal["user_title"], typing_extensions.Literal["user_deleted"], typing_extensions.Literal["post_number"], typing_extensions.Literal["yours"], typing_extensions.Literal["flair_name"], typing_extensions.Literal["topic_slug"], typing_extensions.Literal["username"], typing_extensions.Literal["flair_group_id"], typing_extensions.Literal["can_see_hidden_post"], typing_extensions.Literal["mentioned_users"], typing_extensions.Literal["name"], typing_extensions.Literal["display_username"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
