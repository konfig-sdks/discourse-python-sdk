...
class BaseApi(api_client.Api):
    ...
    def _download_backup_mapped_args(
        self,
        filename: str,
        token: str,
    ...
    async def _adownload_backup_oapg(
        self,
...
class DownloadBackupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_backup(
        self,
        filename: str,
        token: str,
        **kwargs,
        ...
        args = self._download_backup_mapped_args(
            filename=filename,
            token=token,
        )
        return await self._adownload_backup_oapg(
    ...
    def download_backup(
        ...
        return self._download_backup_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DownloadBackup(BaseApi):
    ...
    async def adownload_backup(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_backup(
            filename=filename,
            token=token,
            **kwargs,
        )
    ...
    def download_backup(
        ...
        raw_response = self.raw.download_backup(
            filename=filename,
            token=token,
        )
