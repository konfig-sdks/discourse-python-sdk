...
class RequiredPostsDeleteSinglePostRequest(TypedDict):
    pass

class OptionalPostsDeleteSinglePostRequest(TypedDict, total=False):
...
class PostsDeleteSinglePostRequest(RequiredPostsDeleteSinglePostRequest, OptionalPostsDeleteSinglePostRequest):
    pass
