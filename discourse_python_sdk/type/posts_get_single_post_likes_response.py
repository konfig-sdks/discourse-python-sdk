...
class RequiredPostsGetSinglePostLikesResponse(TypedDict):
    version: int
...
class OptionalPostsGetSinglePostLikesResponse(TypedDict, total=False):
...
class PostsGetSinglePostLikesResponse(RequiredPostsGetSinglePostLikesResponse, OptionalPostsGetSinglePostLikesResponse):
    pass
