...
from discourse_python_sdk.type.users_get_list_of_users_response_item_secondary_emails import UsersGetListOfUsersResponseItemSecondaryEmails

class RequiredUsersGetListOfUsersResponseItem(TypedDict):
...
class OptionalUsersGetListOfUsersResponseItem(TypedDict, total=False):
    email: str

    secondary_emails: UsersGetListOfUsersResponseItemSecondaryEmails

class UsersGetListOfUsersResponseItem(RequiredUsersGetListOfUsersResponseItem, OptionalUsersGetListOfUsersResponseItem):
    pass
