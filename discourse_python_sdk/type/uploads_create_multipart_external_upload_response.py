...
class RequiredUploadsCreateMultipartExternalUploadResponse(TypedDict):
...
class OptionalUploadsCreateMultipartExternalUploadResponse(TypedDict, total=False):
    pass

class UploadsCreateMultipartExternalUploadResponse(RequiredUploadsCreateMultipartExternalUploadResponse, OptionalUploadsCreateMultipartExternalUploadResponse):
    pass
