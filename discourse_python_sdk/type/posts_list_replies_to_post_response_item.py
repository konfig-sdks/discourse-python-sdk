...
from discourse_python_sdk.type.posts_list_replies_to_post_response_item_actions_summary import PostsListRepliesToPostResponseItemActionsSummary
from discourse_python_sdk.type.posts_list_replies_to_post_response_item_reply_to_user import PostsListRepliesToPostResponseItemReplyToUser

class RequiredPostsListRepliesToPostResponseItem(TypedDict):
    version: int
...
class OptionalPostsListRepliesToPostResponseItem(TypedDict, total=False):
    flair_group_id: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class PostsListRepliesToPostResponseItem(RequiredPostsListRepliesToPostResponseItem, OptionalPostsListRepliesToPostResponseItem):
    pass
